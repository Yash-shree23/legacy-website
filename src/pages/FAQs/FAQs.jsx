...
// //     "Can NRIs create wills for Indian assets?",
// //     "Do I need witnesses?"
// //   ];
...
//       answer:
//         "Yes. You can modify or revoke your will at any time while you are mentally competent.",
//     },
//     {
//       category: "NRI Services",
//       question: "Can NRIs create wills for Indian assets?",
//       answer:
//         "Yes. NRIs can create wills specifically covering their assets located in India.",
//     },
//     {
//       category: "Estate Planning",
//       question: "Do I need witnesses for a will?",
//       answer:
//         "Yes. Indian law requires at least two witnesses to sign the will.",
//     },
//     {
//       category: "Estate Planning",
//       question: "What is estate planning?",
//       answer:
//         "Estate planning is the process of organizing assets and legal documents to ensure smooth transfer to beneficiaries.",
//     },
//     {
//       category: "Inheritance",
//       question: "What happens if someone dies without a will?",
//       answer:
//         "Assets are distributed according to applicable succession laws, which may not align with personal wishes.",
//     },
//   ];
...
//               className="w-full p-4 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#C9A227]"
//             />
//           </div>
...
//               <h3 className="font-bold text-xl text-[#0F172A] mb-4">
//                 Categories
//               </h3>

//               <ul className="space-y-3">

//                 <li className="cursor-pointer hover:text-[#C9A227]">
//                   Will Drafting
//                 </li>
...
//             <button className="mt-8 bg-[#C9A227] text-white px-8 py-4 rounded-xl">
//               Book Consultation
//             </button>
