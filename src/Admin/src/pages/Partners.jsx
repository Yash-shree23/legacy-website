...
//   const handleEdit = (p) => {
//     setForm({ name: p.name, industry: p.industry, contact: p.contact, phone: p.phone, email: p.email, website: p.website, logo: p.logo, logoPreview: p.logoPreview || null });
//     setEditId(p.id);
//     setErrors({});
...
//                   <input type="text" placeholder="e.g. Mehta & Associates"
//                     value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
//                   {errors.name && <span className="err">{errors.name}</span>}
//                 </div>
//                 <div className="form-group">
//                   <label>Industry / Type</label>
//                   <input type="text" placeholder="e.g. Legal, Finance, Real Estate"
//                     value={form.industry} onChange={(e) => setForm({ ...form, industry: e.target.value })} />
//                 </div>
//                 {/* <div className="form-group">
//                   <label>Website</label>
//                   <input type="text" placeholder="e.g. www.company.com"
...
//                   <input type="text" placeholder="e.g. Rajesh Mehta"
...
//                   <input type="email" placeholder="e.g. contact@company.com"
...
//                 <span>🔍</span>
//                 <input type="text" placeholder="Search by name, contact, industry…"
...
//                         {/* <td className="muted link">{p.website || "—"}</td> */}
//                         <td>
