...
// // TODO: replace with → fetch('your-php-api/team-members')
// const teamMembers = [
...
// // TODO: replace with → fetch('your-php-api/enquiries')
...
// const statusClass = { Pending: "s-pend", Assigned: "s-assigned", Done: "s-done" };

// // Dropdown component — closes when clicking outside
// function AssignDropdown({ enquiryId, onAssign }) {
...
//   const handleAssign = (enqId, member) => {
//     setEnquiries((prev) =>
//       prev.map((e) => e.id === enqId ? { ...e, status: "Assigned", assignedTo: member } : e)
//     );
//     // TODO: fetch('your-php-api/assign-enquiry', { method:'POST', body: JSON.stringify({ enquiryId: enqId, memberId: member.id }) })
//     flash(`Assigned to ${member.name} successfully!`);
//   };

//   const markDone = (enqId) => {
//     setEnquiries((prev) =>
//       prev.map((e) => e.id === enqId ? { ...e, status: "Done" } : e)
//     );
//     // TODO: fetch('your-php-api/update-status', { method:'POST', body: JSON.stringify({ id: enqId, status:'Done' }) })
//     flash("Enquiry marked as done!");
//   };

//   const markConsultDone = (id) => {
...
//                       <td>
//                         {c.status === "Pending" && (
//                           <button className="btn-done" onClick={() => markConsultDone(c.id)}>Mark Done</button>
//                         )}
//                         {c.status === "Done" && (
//                           <span className="done-label">✔ Done</span>
//                         )}
